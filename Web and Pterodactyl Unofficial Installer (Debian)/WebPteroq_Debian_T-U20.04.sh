...
then
	...
	sleep 5
	sudo mysql -uroot -e "FLUSH PRIVILEGES;ALTER USER 'root'@'localhost' IDENTIFIED BY '${DBUSEDROOTPASS}';FLUSH PRIVILEGES;"
	...
	validdomain="invalid"
		...
		then
			...
			do
				...
				$info
				read -p "Please enter a valid [sub]domain name (e.g. [subdomain.]example.com:) " replace
