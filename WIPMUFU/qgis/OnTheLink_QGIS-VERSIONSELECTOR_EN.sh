...
case $selection in
    1 ) 
        ...
        sudo curl -LO https://raw.githubusercontent.com/onthelink-nl/scripts/master/WIPMUFU/qgis/MUFU/Startup/QgisStartEN.sh
	...
	2 ) 
        ...
        sudo curl -LO https://raw.githubusercontent.com/onthelink-nl/scripts/master/WIPMUFU/qgis/MUFU/Startup/QgisStart3.6EN.sh
