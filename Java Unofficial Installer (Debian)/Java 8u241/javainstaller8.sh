...
sudo rm -rf /home/$USER/javainstaller*
mkdir /home/$USER/javainstaller8u241_64
cd /home/$USER/javainstaller8u241_64

#Information about the creator(s) and the script itself
tput setaf 2; echo "This script is originally created by Misha Opstal"
echo "This script will install the Java JDK version 8u241 (x86_64) on your Linux device (Debian based)."
...
tput setaf 1
echo "Downloading version 8u241 (x86_64)..."
tput setaf 6
sudo curl -LO "https://github.com/onthelink-nl/scripts/raw/master/Java%20Unofficial%20Installer%20(Debian)/Java%208u241/jdk-8u241-linux-x64.tar.gz"
tput setaf 2
...
if [[ ! -d $java_system_prefs_dir ]]; then
    ...
    if grep -q "export JAVA_HOME=.*" home/$USER/.bashrc; then
        sudo sed -i "s|export JAVA_HOME=.*|export JAVA_HOME=/opt/jdk/jdk1.8.0_241/|" home/$USER/.bashrc
    else
        echo "export JAVA_HOME=/opt/jdk/jdk1.8.0_241/" >> home/$USER/.bashrc
    fi
...
tput setaf 2
tput bold
echo "Java JDK Version 8u241 (x86_64) is now installed on your system!"
tput sgr0
...
#Creating temp folder for installation files
sudo rm -rf /home/$USER/javainstaller*
mkdir /home/$USER/javainstaller8u241_32
cd /home/$USER/javainstaller8u241_32

#Information about the creator(s) and the script itself
tput setaf 2; echo "This script is originally created by Misha Opstal"
echo "This script will install the Java JDK version 8u241 (i586) on your Linux device (Debian based)."
tput bold; echo "We are not the creators of Java and this is an unofficial script, we do NOT claim Java as our content and all copyrights, trademarks and other intellectual property belong to the Oracle Corporation!"
tput setaf 5; echo -n "Our Discord Server: "
echo -e '\e]8;;https://discordapp.com/invite/UfbNmJb\aOTL Discord server\e]8;;\a'
echo -n "The Java website: "
...
echo "Dependencies have been installed"
tput setaf 1
echo "Downloading version 8u241 (i586)..."
tput setaf 6
sudo curl -LO "https://github.com/onthelink-nl/scripts/raw/master/Java%20Unofficial%20Installer%20(Debian)/Java%208u241/jdk-8u241-linux-i586.tar.gz"
tput setaf 2
echo "Files have been downloaded"
sleep 1
tput setaf 1
...
echo "Extracting installation files..."
tput setaf 6
sudo tar -zxf jdk-8u241-linux-i586.tar.gz -C /opt/jdk
tput setaf 2
echo "Installation files extracted"
tput setaf 1
echo "Copying files..."
...
tput setaf 2
tput bold
echo "Java JDK Version 8u241 (i586) is now installed on your system!"
tput sgr0
