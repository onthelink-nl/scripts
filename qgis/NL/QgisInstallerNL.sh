...
function finish {
    tput bold; tput setaf 1; echo "Bestand ${currentscript} verwijderen..."; shred -u ${currentscript}; sudo curl -LO https://raw.githubusercontent.com/onthelink-tk/scripts/master/OnTheLink%20MENU_NL.sh && sudo bash "OnTheLink%20MENU_NL.sh"
}
