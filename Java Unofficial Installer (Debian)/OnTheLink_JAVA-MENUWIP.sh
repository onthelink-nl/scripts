...
OnTheLink JAVA-MENU | Version(s): 10.0.2 (64) / 9.0.4 (64) / 8u241 (64-32) / 7u80 (64-32) | This MENU and it's SCRIPTS are still in WIP and WILL IN MOST CASES cause issues, please use our stable java menu...
"
...
case $selection in
	...
	3 ) 
        ...
        sudo curl -LO "https://raw.githubusercontent.com/onthelink-nl/scripts/master/Java%20Unofficial%20Installer%20(Debian)/Java%208u241/javainstaller8WIP.sh"
